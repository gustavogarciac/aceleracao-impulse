...
export const TestimonialsSection = () => {
  return (
    <section className="flex flex-col items-center justify-center gap-12 pt-16 px-6 pb-20 bg-theme-blue-default">
      <h2 className="text-zinc-50 subtitle font-bold text-2xl">
        Nossos alunos estão comentando...
      </h2>

      <div className="flex flex-col gap-14 w-full md:grid grid-cols-2 md:gap-10 max-w-4xl mx-auto">
